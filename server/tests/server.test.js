...
const {app} = require('./../server'),
  ...
  {dummyTodos, populateTodos, dummyUsers, populateUsers} = require('./seed/seed');
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not remove a todo if owner missmatch', (done) => {
    var hexId = dummyTodos[0]._id.toHexString();
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not update the todo with owner missmatch', (done) => {
    var hexId = dummyTodos[0]._id.toHexString();
    var text = 'This is the new text';
